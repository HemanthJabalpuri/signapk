...
public class ZioEntry implements Cloneable {
    ...
    public void readLocalHeader() throws IOException {
        ...
        boolean debug = false; if (debug) System.out.println(tmpInt + "" + filename + "" + extra + "" + tmpShort); // supress warnings of above unused variables
    }
    ...
    public void writeLocalEntry(ZipOutput output) throws IOException {
        ...
        if (ZipInput.toAlign() && compression == 0) {
